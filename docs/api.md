...
Depended on by: CLAUDE.md, docs/clients.md, docs/epistemic_uplift.md, docs/extending-the-kernel.md, docs/manager-probe-findings.md, docs/quickstart.md, docs/register-view.md, docs/thin-clients.md
---
