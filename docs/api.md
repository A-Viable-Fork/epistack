...
Depended on by: CLAUDE.md, docs/clients.md, docs/epistemic_uplift.md, docs/extending-the-kernel.md, docs/kernel-at-inference.md, docs/kernel-at-training.md, docs/manager-probe-findings.md, docs/quickstart.md, docs/register-view.md, docs/thin-clients.md, docs/workflow-atlas.md, docs/workflow-consumer-adversarial.md, docs/workflow-consumer-crux.md, docs/workflow-consumer-evidence.md, docs/workflow-producer-data.md, docs/workflow-producer-video.md, docs/workflow-producer-web.md
---
