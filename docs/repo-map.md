...
Nodes: 86. Import edges: 39. Runtime flow edges: 10. All import edges satisfy the invariants (kernel<-kernel, api<-{kernel,api}, periphery never imports kernel directly).
