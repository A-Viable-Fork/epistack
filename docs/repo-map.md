...
Nodes: 220. Import edges: 463. Runtime flow edges: 41. All import edges satisfy the invariants (kernel<-kernel, api<-{kernel,api}, periphery never imports kernel directly).
...
- `kernel/compute/registry.mjs` -> `kernel/compute/canonical-packs.mjs`  *(kernel -> kernel)*
- `kernel/compute/registry.mjs` -> `kernel/compute/transforms.mjs`  *(kernel -> kernel)*
...
- `api/client-api.mjs` -> `kernel/compute/registry.mjs`  *(api -> kernel)*
...
- `api/providers/local-provider.mjs` -> `kernel/gate/comment-guard.mjs`  *(api -> kernel)*
...
- `build/check-certificate.mjs` -> `kernel/gate/gate.mjs`  *(build -> kernel)*
- `build/check-certificate.mjs` -> `kernel/gate/verify.mjs`  *(build -> kernel)*
- `build/check-certificate.mjs` -> `kernel/schema/records.mjs`  *(build -> kernel)*
- `build/check-certificate.mjs` -> `kernel/schema/tables.mjs`  *(build -> kernel)*
...
- `build/check-comment.mjs` -> `corpora/_shared/common-types.js`  *(build -> corpus)*
- `build/check-comment.mjs` -> `kernel/gate/comment-guard.mjs`  *(build -> kernel)*
- `build/check-comment.mjs` -> `kernel/gate/gate.mjs`  *(build -> kernel)*
- `build/check-comment.mjs` -> `kernel/gate/verify.mjs`  *(build -> kernel)*
- `build/check-comment.mjs` -> `kernel/schema/canonical.mjs`  *(build -> kernel)*
- `build/check-comment.mjs` -> `kernel/schema/records.mjs`  *(build -> kernel)*
- `build/check-comment.mjs` -> `kernel/schema/tables.mjs`  *(build -> kernel)*
- `build/check-comment.mjs` -> `kernel/store/apply.mjs`  *(build -> kernel)*
- `build/check-comment.mjs` -> `kernel/store/decay.mjs`  *(build -> kernel)*
- `build/check-comment.mjs` -> `kernel/store/state.mjs`  *(build -> kernel)*
...
- `build/check-compute.mjs` -> `api/client-api.mjs`  *(build -> api)*
- `build/check-compute.mjs` -> `api/providers/local-provider.mjs`  *(build -> api)*
...
- `build/check-compute.mjs` -> `kernel/compute/registry.mjs`  *(build -> kernel)*
...
- `build/check-fork-contest.mjs` -> `api/contest.js`  *(build -> api)*
- `build/check-fork-contest.mjs` -> `api/fork.js`  *(build -> api)*
- `build/check-fork-contest.mjs` -> `build/adoption.mjs`  *(build -> build)*
- `build/check-fork-contest.mjs` -> `kernel/gate/gate.mjs`  *(build -> kernel)*
- `build/check-fork-contest.mjs` -> `kernel/schema/records.mjs`  *(build -> kernel)*
- `build/check-fork-contest.mjs` -> `kernel/schema/tables.mjs`  *(build -> kernel)*
- `build/check-fork-contest.mjs` -> `kernel/schema/type-hash.mjs`  *(build -> kernel)*
- `build/check-fork-contest.mjs` -> `kernel/store/apply.mjs`  *(build -> kernel)*
- `build/check-fork-contest.mjs` -> `kernel/store/decay.mjs`  *(build -> kernel)*
- `build/check-fork-contest.mjs` -> `kernel/store/state.mjs`  *(build -> kernel)*
...
- `build/check-math-embed.mjs` -> `kernel/schema/sha256.mjs`  *(build -> kernel)*
...
- `build/math-build.mjs` -> `corpora/math/math-data.js`  *(build -> corpus)*
- `build/math-build.mjs` -> `corpora/math/tables.js`  *(build -> corpus)*
- `build/math-build.mjs` -> `kernel/gate/gate.mjs`  *(build -> kernel)*
- `build/math-build.mjs` -> `kernel/schema/records.mjs`  *(build -> kernel)*
- `build/math-build.mjs` -> `kernel/schema/tables.mjs`  *(build -> kernel)*
...
- `kernel/compute/registry.mjs` **checked-by** `build/check-compute.mjs`
...
- `build/check-comment.mjs` **loads-corpus** `corpora/_shared/common-types.js`
