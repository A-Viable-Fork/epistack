...
Nodes: 106. Import edges: 130. Runtime flow edges: 17. All import edges satisfy the invariants (kernel<-kernel, api<-{kernel,api}, periphery never imports kernel directly).
