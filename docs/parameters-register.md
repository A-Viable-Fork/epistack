...
Depends on: docs/composition-spec.md, docs/kernel-taxonomy.md, docs/knowledge-system-how.md, docs/trust-and-view.md, docs/contract-register.md
Depended on by: README.md, docs/adversarial-robustness.md, docs/adversarial_walkthrough.md, docs/authoring-methodology.md, docs/community-backend.md, docs/community-invitation.md, docs/coordination-layer-spec.md, docs/document-style-guide.md, docs/ecosystem-guide.md, docs/epistemic_uplift.md, docs/extending-the-kernel.md, docs/kernel-workflow-guide.md, docs/lineage-architecture-findings.md, docs/protocol-spec.md, docs/reading-the-brief.md, docs/substrate-map.md, docs/what-stands-without-trust.md, docs/the-minimum-constitution.md
---
