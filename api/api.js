...
(function (root) {
  ...
  function createApi(sources) {
    ...
    return {
      ...
      // grounding is now the v3 reading: the propose/read contract returns each claim's earned grade
      // (api/client-api.mjs, api/providers/local-provider.mjs), and api.robustness reads fragility
      // beside it. The Stage 1 lattice grounding read (contamination.js) was retired in Prompt 16.
