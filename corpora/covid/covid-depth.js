...
const claims = [
  ...
  W("w.will.tmp", "vantreuren", "Will Van Treuren: retrospective serology of 3,850 blood-bank samples and 640 ILI throat swabs (Sep-Dec 2019 Wuhan) showed zero SARS-CoV-2 seropositivity, immune to ascertainment bias, strong ZO", "strong ZO", "strong-ZO", "stated"),
  ...
  F("def.zo.61tasks", "Eric Stansifer: across the 61 DEFUSE tasks, WIV's role was bat sampling, captive-bat vaccine testing, and basic assays; the chimera engineering was designated for UNC, not WIV", "reader:stansifer", "asserted"),
